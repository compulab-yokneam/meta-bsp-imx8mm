...
git -C imx-mkimage checkout -f rel_imx_5.4.3_2.0.0
</pre>
...
git -C imx-atf checkout -f rel_imx_5.4.3_2.0.0
...
git -C uboot-imx checkout -f rel_imx_5.4.3_2.0.0
...
git -C imx-optee-os checkout -f rel_imx_5.4.3_2.0.0
