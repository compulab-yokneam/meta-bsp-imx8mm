...
[source,console]
git clone -b iot-gate-imx8_r1.0 https://github.com/compulab-yokneam/meta-bsp-imx8mm.git sources/meta-bsp-imx8mm/

# Set a desire machine
* `iot-gate-imx8`
[source,console]
COMPULAB_MACHINE=iot-gate-imx8
...
[source,console]
MACHINE=${COMPULAB_MACHINE} source sources/meta-bsp-imx8mm/tools/setup-iot-get-imx8-env -b build-xwayland
